...
func mintTokenTestnet(t *testing.T, receiver testaccount, config lib.Configuration) {
	...
	transactioncode = lib.ReplaceAddressPlaceholders(transactioncode, config.Contractaddresses.NonFungibleToken, config.Contractaddresses.Veolet, "", "")
...
func transferTokenTestnet(t *testing.T, config lib.Configuration, sender testaccount, recipient testaccount, tokenID uint64) {
	...
	transfercode = lib.ReplaceAddressPlaceholders(transfercode, config.Contractaddresses.NonFungibleToken, config.Contractaddresses.Veolet, "", "")
...
func fetchCollectionTestnet(t *testing.T, config lib.Configuration, target testaccount) cadence.Value {
...
func getTestingAccount(t *testing.T, config lib.Configuration) testaccount {
...
func fetchNFTTestnet(t *testing.T, config lib.Configuration, target testaccount, tokenID uint64) cadence.Value {
...
func setMediaURLTestnet(t *testing.T, config lib.Configuration, target testaccount, tokenID uint64, newurl string) {
	...
	code = lib.ReplaceAddressPlaceholders(code, "", config.Contractaddresses.Veolet, "", "")
...
func getStorageInfoTestnet(t *testing.T, config lib.Configuration, target testaccount) cadence.Value {
