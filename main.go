...
func main() {
	...
	lib.MintToken(configuration, serviceaddress, "test.com", "Creator Name", serviceaddress)
	...
	lib.TransferToken(configuration, serviceAddressHex, servicePrivKeyHex, newAddress, 0)
